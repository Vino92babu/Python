...
multiplication ,division and also python have floor division,exponentiation.
...
Division ( / ) => This is a binary operator that is used to divide the first operand(dividend)
